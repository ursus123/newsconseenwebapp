...
import { Download, FileText, Mail, Calendar, X, Loader2, Check } from "lucide-react";
...
async function exportToExcel(selectedReports) {
  ...
  // Add metadata sheet
  const metaData = [
    ["Report", "Generated By", "Generated At", "API Source"],
    ["Newsconseen Analytics Export", "Newsconseen App", format(new Date(), "PPpp"), API_BASE],
  ];
...
export default function ReportExporter() {
  ...
  const handleExport = async (type) => {
    ...
    try {
      ...
      if (type === "csv") {
        // Export first selected as CSV
        const first = selected[0];
        if (first) await exportToCSV(first, ENDPOINTS[first]);
      }
      setDone(type);
            ...
            <CardContent className="p-6 space-y-5">
              ...
              <div>
                ...
                <div className="flex gap-2 mt-2">
                  <button
                    onClick={() => setSelected(Object.keys(ENDPOINTS))}
              ...
              <div className="bg-slate-50 rounded-xl px-4 py-3">
                <p className="text-xs text-slate-500">
                  Data is fetched live from your Railway analytics API

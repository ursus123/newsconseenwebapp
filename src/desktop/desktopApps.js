...
export const DESKTOP_APPS = [
  ...
  app({ id: "datareadiness", name: "Data Readiness", icon: "🧹", color: "#f97316", route: "/DataReadiness", category: "Analytics", description: "Diagnose and repair data quality issues.", keywords: ["data quality", "repair", "cleanup", "readiness"], roles: adminRoles }),

...
export const APP_REGISTRY = [
  ...
  { id: "leaverequest",      name: "Leave Request",              emoji: "🏖️", description: "Submit and approve annual, sick and emergency leave",                                     category: "HR",          route: "LeaveRequest",        color: "cyan",    roles: "all",        plan: "starter",      exists: false, backend: "ontology",  ontologyObjects: ["Person", "Task"] },
  ...
  { id: "expenseclaim",      name: "Expense Claim",              emoji: "💸",  description: "Submit and approve staff expense reimbursements",                                        category: "HR",          route: "ExpenseClaim",        color: "emerald", roles: "all",        plan: "starter",      exists: false, backend: "ontology",  ontologyObjects: ["Person", "Transaction"] },
  ...
  { id: "purchaseorder",     name: "Purchase Order",             emoji: "🛒",  description: "Request and approve purchases with automatic transaction creation",                     category: "Inventory",   route: "PurchaseOrder",       color: "blue",    roles: "all",        plan: "starter",      exists: false, backend: "ontology",  ontologyObjects: ["Product", "Transaction", "Enterprise"] },
  ...
  { id: "goodsreceived",     name: "Goods Received",             emoji: "📬",  description: "Confirm delivery of ordered goods and update stock automatically",                      category: "Inventory",   route: "GoodsReceived",       color: "green",   roles: "all",        plan: "starter",      exists: false, backend: "ontology",  ontologyObjects: ["Product", "Transaction"] },
  ...
  { id: "incidentreport",    name: "Incident Report",            emoji: "🚨",  description: "Log accidents, near-misses, falls and complaints",                                      category: "Healthcare",  route: "IncidentReport",      color: "red",     roles: "all",        plan: "starter",      exists: false, backend: "ontology",  ontologyObjects: ["Person", "Task"] },
  ...
  // FIELD & OPERATIONS
  { id: "visitorlog",        name: "Visitor Log",                emoji: "🪪",  description: "Sign guests in and out with automatic timestamps",                                     category: "Field",       route: "VisitorLog",          color: "purple",  roles: "all",        plan: "starter",      exists: false, backend: "ontology",  ontologyObjects: ["Person", "Task"] },
  ...
  { id: "fieldvisitreport",  name: "Field Visit Report",         emoji: "📝",  description: "Staff submit structured reports after client site visits",                            category: "Field",       route: "FieldVisitReport",    color: "indigo",  roles: "all",        plan: "starter",      exists: false, backend: "ontology",  ontologyObjects: ["Person", "Task", "Enterprise"] },
  ...
  { id: "maintenancerequest",name: "Maintenance Request",        emoji: "🛠️", description: "Report broken equipment or facilities issues for repair",                              category: "Field",       route: "MaintenanceRequest",  color: "orange",  roles: "all",        plan: "starter",      exists: false, backend: "ontology",  ontologyObjects: ["Task", "Product"] },
  ...
  // COMPLIANCE & QUALITY
  { id: "inspectionchecklist",name: "Inspection Checklist",      emoji: "✅",  description: "Daily and weekly facility inspection forms with sign-off",                           category: "Compliance",  route: "InspectionChecklist", color: "emerald", roles: "all",        plan: "starter",      exists: false, backend: "ontology",  ontologyObjects: ["Task", "Enterprise"] },
  ...
  { id: "documentexpiry",    name: "Document Expiry",            emoji: "📁",  description: "Alert when contracts, certificates and documents are expiring",                      category: "Compliance",  route: "DocumentExpiry",      color: "red",     roles: "admin_only", plan: "starter",      exists: false, backend: "ontology",  ontologyObjects: ["Enterprise", "Task"] },

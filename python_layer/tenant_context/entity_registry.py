...
ENTITY_REGISTRY = {
    ...
    "graph_assertion": _object("graph_assertions", "governance", ("operational_unit_id", "assertion_key", "relationship_rule_id", "source_node_id", "predicate", "target_node_id", "assertion_class", "assertion_state", "valid_from", "valid_until", "observed_at", "confirmed_at", "rejected_at", "superseded_by", "evidence_version", "evidence", "reason", "actor_user_id", "carrier_type", "carrier_record_id", "matching_method", "candidate_count", "candidate_confidence", "permitted_actions", "raw_predicate", "proposed_operation", "proposed_patch", "bulk_group_key", "evidence_hash", "business_consequence", "last_evaluated_at"), classification="governance", sensitivity="internal", enabled=True),
    ...
    "graph_quality_finding": _object("graph_quality_findings", "governance", ("operational_unit_id", "finding_key", "issue_code", "severity", "scope_type", "scope_id", "affected_count", "cause", "business_consequence", "owner_user_id", "owner_display_name", "suggested_repair", "evidence", "bulk_repair_eligible", "verification_status", "status", "alert_state", "task_id", "recommendation_id", "first_detected_at", "last_detected_at", "resolved_at", "resolved_by", "created_at"), classification="governance", sensitivity="internal", enabled=True),
    "graph_quality_resolution_event": _object("graph_quality_resolution_events", "governance", ("finding_id", "finding_key", "event_type", "from_status", "to_status", "actor_user_id", "reason", "evidence", "occurred_at"), classification="governance", sensitivity="internal", enabled=True, include_updated=False),
    "graph_field_report": _object("graph_field_reports", "governance", ("operational_unit_id", "report_type", "subject_node_id", "subject_type", "subject_record_id", "description", "evidence", "proposed_correction", "status", "reported_by", "reported_at", "reviewed_by", "reviewed_at", "resolution"), classification="governance", sensitivity="restricted", enabled=True, include_updated=False),
    "external_observation": _object("external_observations", "intelligence", ("operational_unit_id", "observation_type", "title", "summary", "severity", "status", "source_name", "source_url", "source_record_id", "retrieved_at", "freshness_at", "location", "valid_from", "valid_until", "confidence", "expires_at", "provenance", "source_payload_hash", "created_by", "created_at"), classification="derived_intelligence", sensitivity="internal", enabled=True),
    "external_observation_match": _object("external_observation_matches", "intelligence", ("observation_id", "target_type", "target_id", "predicate", "matching_method", "confidence", "evidence", "verification_status", "valid_from", "valid_until", "expires_at", "created_by", "created_at"), classification="derived_intelligence", sensitivity="internal", enabled=True),
    ...
    "task": _object("tasks", "work", ("title", "task_type", "status", "priority", "due_date", "completed_at", "assigned_to_person_id", "assigned_to_email", "assigned_to_name", "related_person", "related_person_id", "enterprise", "enterprise_id"), tier="core", unit_owned=True),

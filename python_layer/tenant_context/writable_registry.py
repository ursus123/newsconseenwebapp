...
CORE_WRITABLE_FIELDS = {
    ...
    "task": {"title","description","task_type","status","priority","due_date","scheduled_date","scheduled_time","completed_at","assigned_to_person_id","assigned_to_email","assigned_to_name","enterprise_id","enterprise","related_person","related_person_id","outcome","outcome_notes","notes","internal_notes","company_id","created_by"},

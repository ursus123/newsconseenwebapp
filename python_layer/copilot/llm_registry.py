...
TOOL_CAPABILITIES = {
    ...
    "plan_data_repairs": "read_company_data",
    "run_analysis_modules": "read_company_data",
    "plan_visual_output": "read_company_data",
    ...
    "plan_source_enrichment": "read_default_brain",
    ...
    "get_idjwi_memory_manifest": "read_default_brain",
    "explain_idjwi_memory": "save_memory",
    "find_idjwi_memory_conflicts": "save_memory",
    "scope_idjwi_memory": "save_memory",
    "plan_onboarding_intake": "read_default_brain",
